...
object FileMapTable {
    ...
    private val MIME_MapTable = arrayOf(
        ...
        arrayOf(".3gpp", "video/3gpp"),
        arrayOf(".aac", "audio/x-mpeg"),
        arrayOf(".amr", "audio/x-mpeg"),
    ...
    fun getFileName(filePath: String):String{
        if (filePath.isEmpty()){
            throw NullPointerException("FilePath is not null")
        }
        if (!filePath.contains("/")){
            throw IllegalArgumentException("IllegalArgumentException filePath")
        }
        val startIndex = filePath.lastIndexOf("/")
    ...
    fun openFile(context: Context, filePath: String?) {
        ...
        try {
            ...
            val contentUri = UriToPathUtil.getUriForFile(context, file)
            intent.setDataAndType(contentUri, filePath?.let { getMIMEType(it) })
